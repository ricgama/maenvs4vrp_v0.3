...
INSTANCES_PATH = 'sdvrptw/data/benchmark'
DATA_PATH = './sdvrptw/data/benchmark'
...
class BenchmarkInstanceGenerator(InstanceBuilder):
    ...
    def get_list_of_instances(cls):
        ...
        for set_name in ('Solomon', 'Homberger', 'Bianchessi'):
    ...
    def __init__(self,
                 ...
                 num_nodes:int=None,
                 speed:float=None,
                 instance_name:str='Solomon',
                 list_of_instances:set=None,
        ...
        assert instance_name in ["Solomon", "Homberger", "Bianchessi"], f"instance unknown type"
    ...
    def parse_instance_data(self, instance_data: list) -> Dict:
        ...
        if self.instance_name == 'Bianchessi':
            capacity = 100
        else:
        ...
        if self.instance_name in ['Solomon', 'Homberger', 'Bianchessi']:
    ...
    def get_instance(self, instance_name:str, num_agents:int=None) -> Dict:
        ...
        if instance is None:
            available = list(self.instances_data.keys())
            raise KeyError(
