...
INSTANCES_PATH = 'cvrptw/data/generated'
DATA_PATH = './cvrptw/data/generated'
...
class InstanceGenerator(InstanceBuilder):
    ...
    def __init__(self,
        ...
        Args:
            ...
            service_times(float): Service time in the nodes. Defaults to 0.2.
            speed(float): Vehicles' speed. Defaults to 1.0.
            instance_name(str): Name of the instance to generate. Defaults to "validation".
            list_of_instances(list, optional): List of instance file names. Defaults to None.
        ...
        if self.instance_name is not None and list_of_instances is None:
    ...
    def sample_instance(self,
        ...
        Args:
            ...
            service_times(int, optional): Service time in the nodes. Defaults to None.
...
if __name__ == '__main__':
    ...
    for num_nodes, n_agent in [(101, 20)]:
