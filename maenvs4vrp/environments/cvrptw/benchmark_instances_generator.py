...
DATA_PATH = './cvrptw/data/benchmark'
...
class BenchmarkInstanceGenerator(InstanceBuilder):
    ...
    def get_list_of_instances(cls):
        ...
        for set_name in ('Solomon', 'Homberger'):
    ...
    def load_list_of_instances(self, list_of_instances:Optional[list]=None):
        ...
        if list_of_instances:
            self.set_of_instances = list_of_instances
    ...
    def sample_first_n_services(self,
        ...
        Args:
            instance_name(str, optional): Specific instance name to load. Defaults to self.instance_name.
    ...
    def random_sample_instance(self,
        ...
        Args:
            instance_name(Optional[str]): Specific instance name to sample from. Defaults to None (random).
