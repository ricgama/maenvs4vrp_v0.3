...
INSTANCES_PATH = 'toptw/data/generated'
DATA_PATH = './toptw/data/generated'
...
class InstanceGenerator(InstanceBuilder):
    ...
    def random_generate_instance(self,
        ...
        if self.profits == 'constant':
            ...
            self.profits = torch.randint(low = 1, high=100, size = (*self.batch_size, self.num_nodes), dtype = torch.float, device=self.device) // 10 # uniform
